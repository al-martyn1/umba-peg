...
/*! \file
    \brief Токенизатор/лексер для umba-peg V1
 */
...
//! Тут мы настраиваем голенький токенизатор - добавляем в него всякие фильтры, и тп. 
// При этом финальный обработчик у него уже должен быть установлен.
...
typename TokenizerBuilder::tokenizer_type makeTokenizerPeg(TokenizerBuilder builder, TokenHandler tokenHandler)
{
